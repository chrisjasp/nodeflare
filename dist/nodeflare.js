(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("stream"), require("util"), require("crypto"), require("buffer"), require("url"), require("express"), require("http"), require("path"), require("bluebird"), require("fs"), require("https"), require("zlib"), require("sequelize"), require("events"), require("net"), require("querystring"), require("string_decoder"), require("tty"));
	else if(typeof define === 'function' && define.amd)
		define(["stream", "util", "crypto", "buffer", "url", "express", "http", "path", "bluebird", "fs", "https", "zlib", "sequelize", "events", "net", "querystring", "string_decoder", "tty"], factory);
	else if(typeof exports === 'object')
		exports["nodeflare"] = factory(require("stream"), require("util"), require("crypto"), require("buffer"), require("url"), require("express"), require("http"), require("path"), require("bluebird"), require("fs"), require("https"), require("zlib"), require("sequelize"), require("events"), require("net"), require("querystring"), require("string_decoder"), require("tty"));
	else
		root["nodeflare"] = factory(root["stream"], root["util"], root["crypto"], root["buffer"], root["url"], root["express"], root["http"], root["path"], root["bluebird"], root["fs"], root["https"], root["zlib"], root["sequelize"], root["events"], root["net"], root["querystring"], root["string_decoder"], root["tty"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_18__, __WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_23__, __WEBPACK_EXTERNAL_MODULE_39__, __WEBPACK_EXTERNAL_MODULE_40__, __WEBPACK_EXTERNAL_MODULE_41__, __WEBPACK_EXTERNAL_MODULE_42__, __WEBPACK_EXTERNAL_MODULE_130__, __WEBPACK_EXTERNAL_MODULE_131__, __WEBPACK_EXTERNAL_MODULE_132__, __WEBPACK_EXTERNAL_MODULE_133__, __WEBPACK_EXTERNAL_MODULE_134__) {
...
var User = exports.User = function User(data) {
  ...
  if (data.details != null) {
    ...
    try {
      for (var _iterator = Object.keys(data.details)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var o = _step.value;
...
var CreateUser = exports.CreateUser = function CreateUser(data) {
  ...
  if (data.details != null) {
    ...
    try {
      for (var _iterator2 = Object.keys(data.details)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        var o = _step2.value;
...
var EditUser = exports.EditUser = function EditUser(data) {
  ...
  if (data.details != null) {
    ...
    try {
      for (var _iterator3 = Object.keys(data.details)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        var o = _step3.value;
...
var UserEntity = exports.UserEntity = function () {
  function UserEntity(data) {
    ...
    if (data.details != null) {
      ...
      try {
        for (var _iterator4 = Object.keys(data.details)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var o = _step4.value;
  ...
  _createClass(UserEntity, [{
    key: 'execute',
    value: function execute(action, passwordHasher) {
      this.version++;
    ...
    key: 'updatePassword',
    value: function updatePassword(action, passwordHasher) {
      if (action.password !== action.confirmpassword) {
        throw Error('Passwords Do Not Match');
      }

      var passHash = passwordHasher.generateHash(action.password);
    ...
    key: 'editUser',
    value: function editUser(action) {
    ...
    key: 'create',
    value: function create(idGenerator, passwordHasher, data) {
      var passHash = passwordHasher.generateHash(data.password);
...
var onFinished = __webpack_require__(116)
...
function createWritableStdioStream (fd) {
  ...
  switch (tty_wrap.guessHandleType(fd)) {
    ...
    case 'PIPE':
    case 'TCP':
      var net = __webpack_require__(131);
...
var convert = __webpack_require__(82).convert;
var bodyStream = __webpack_require__(104);
var PassThrough = __webpack_require__(0).PassThrough;
var FetchError = __webpack_require__(37);
...
var rng = __webpack_require__(128);
...
var MailSender = exports.MailSender = function () {
  function MailSender() {
    _classCallCheck(this, MailSender);
  }

  _createClass(MailSender, null, [{
    key: 'send',
    value: function send(mailgunUrl, sendto, sendfrom, message, subject) {
      var fetch = __webpack_require__(105);
      ...
      return fetch(mailgunUrl, { method: 'POST', body: form }).then(function (response) {
...
var UserCatalog = exports.UserCatalog = function () {
  function UserCatalog() {
    _classCallCheck(this, UserCatalog);

    this.dependencies = 'userStore=UserStore,passwordHasher=PasswordHasher,eventHub=EventHub';
  }

  _createClass(UserCatalog, [{
    key: 'ready',
    value: function ready() {
      var _this = this;

      this.eventHub.attachEventHub(this);
      this.subscribe(UserCatalog.Update, function () {
        return _this.updateCatalog();
      });
      this._catalog = {
        version: 0,
        users: []
    ...
    value: function updateCatalog() {
      ...
      this._catalog.users = [];
      return this.userStore.fetchAll().then(function (u) {
        _this2._catalog.users = u.map(function (e) {
          return e.toUser();
        });
      });
    }
    ...
    key: 'push',
    value: function push(newUser) {
      var userIdx = this._catalog.users.findIndex(function (e) {
    ...
    value: function fetchUser(id) {
      var user = this._catalog.users.find(function (e) {
        return e.id === id;
      });
    ...
    key: 'fetchByEmail',
    value: function fetchByEmail(email) {
      var user = this._catalog.users.find(function (e) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__enum__ = __webpack_require__(70);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__options__ = __webpack_require__(71);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__url_builder__ = __webpack_require__(72);
...
var defer = __webpack_require__(50);
...
var iterate    = __webpack_require__(26)
  , initState  = __webpack_require__(27)
  , terminator = __webpack_require__(28)
  ;
...
var AuthenticationRequest = exports.AuthenticationRequest = function () {
  function AuthenticationRequest(data) {
    _classCallCheck(this, AuthenticationRequest);

    this.load(data);
  }

  _createClass(AuthenticationRequest, [{
    key: 'load',
...
var relative = __webpack_require__(19).relative
...
var CombinedStream = __webpack_require__(68);
var util = __webpack_require__(1);
...
var fs = __webpack_require__(39);
var mime = __webpack_require__(36);
var asynckit = __webpack_require__(49);
...
exports.SqliteConnection = exports.PgConnectionUri = exports.PgConnection = undefined;
...
var PgConnection = exports.PgConnection = function (_Sequelize) {
  _inherits(PgConnection, _Sequelize);

  function PgConnection(host, username, pass, dbname, withSSL) {
    _classCallCheck(this, PgConnection);

    return _possibleConstructorReturn(this, (PgConnection.__proto__ || Object.getPrototypeOf(PgConnection)).call(this, dbname, username, pass, {
      dialect: 'postgres',
      dialectOptions: {
        ssl: withSSL
      },
...
var PgConnectionUri = exports.PgConnectionUri = function (_Sequelize2) {
  _inherits(PgConnectionUri, _Sequelize2);

  function PgConnectionUri(uri, withSSL) {
    _classCallCheck(this, PgConnectionUri);

    return _possibleConstructorReturn(this, (PgConnectionUri.__proto__ || Object.getPrototypeOf(PgConnectionUri)).call(this, uri, {
      dialect: 'postgres',
      dialectOptions: {
        ssl: withSSL
      },
...
var SqliteConnection = exports.SqliteConnection = function (_Sequelize3) {
  _inherits(SqliteConnection, _Sequelize3);
  ...
  function SqliteConnection(path) {
    ...
    var dbname = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';

    _classCallCheck(this, SqliteConnection);

    return _possibleConstructorReturn(this, (SqliteConnection.__proto__ || Object.getPrototypeOf(SqliteConnection)).call(this, dbname, username, pass, {
      dialect: 'sqlite',
      logging: false,
      storage: path
    }));
...
exports.IocBuilder = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _authenticationService = __webpack_require__(54);

var _authenticationProvider = __webpack_require__(53);

var _passwordHasher = __webpack_require__(56);

var _userStore = __webpack_require__(58);

var _userKernel = __webpack_require__(57);

var _userCache = __webpack_require__(21);

var _myService = __webpack_require__(55);

var _ctjsEvent = __webpack_require__(69);

var _userCommon = __webpack_require__(30);
...
var IocBuilder = exports.IocBuilder = function () {
  function IocBuilder() {
    _classCallCheck(this, IocBuilder);
  }

  _createClass(IocBuilder, null, [{
    key: 'build',
    value: function build(AppRoot) {
      // Main
      ctx.register('AppRoot').object(AppRoot);
      // Stores Registration
      ctx.register('UserStore', _userStore.UserStore);
      // Services
      ctx.register('AuthenticationService', _authenticationService.AuthenticationService);
      ctx.register('MyService', _myService.MyService);
      // Authentication
      ctx.register('AuthenticationProvider', _authenticationProvider.AuthenticationProvider);
      ctx.register('PasswordHasher', _passwordHasher.PasswordHasher);
      // Caching
      ctx.register('UserCatalog', _userCache.UserCatalog);
      // Kernels
      ctx.register('UserKernel', _userKernel.UserKernel);
      // EventHub
      ctx.register('EventHub', _ctjsEvent.EventHub);
...
var _wl = ['/favicon.ico', '/auth/login', '/auth/passwordreset', '/my/user/create'];

var TokenAuthenticator = exports.TokenAuthenticator = function () {
  function TokenAuthenticator() {
    _classCallCheck(this, TokenAuthenticator);
  }

  _createClass(TokenAuthenticator, null, [{
    key: 'addwhitelist',
    value: function addwhitelist(val) {
    ...
    value: function handleRequest(req, res, next) {
      ...
      if (TokenAuthenticator.whitelist.some(function (u) {
        return path.startsWith(u);
      })) {
        return next();
      } else if (authHeader != null && !TokenAuthenticator.whitelist.some(function (u) {
        return path.startsWith(u);
      })) {
        return TokenAuthenticator.authenticateHeader(authHeader).then(function (token) {
    ...
    value: function authenticateHeader(authHeader) {
      var authProvider = ctx.get('AuthenticationProvider');

      var token = authHeader.split('Token ');
      if (!(token.length === 2)) {
...
/* harmony export (immutable) */ __webpack_exports__["Di"] = Di;
...
module.exports =
{
  parallel      : __webpack_require__(51),
...
exports.AuthenticationProvider = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _njwt = __webpack_require__(109);

var _njwt2 = _interopRequireDefault(_njwt);

var _secureRandom = __webpack_require__(122);
...
var _mailSender = __webpack_require__(20);
...
var AuthenticationProvider = function () {
  ...
  _createClass(AuthenticationProvider, [{
    ...
    key: 'authenticate',
    value: function authenticate(authenticationRequest) {
      var _this = this;

      return this.userStore.fetchUserByEmail(authenticationRequest.emailAddress).then(function (userEo) {
        if (!_this.passwordHasher.verifyPassword(authenticationRequest.password, userEo.passwordSalt, userEo.passwordHash)) {
        ...
        var jwt = _njwt2.default.create(claims, _this.signingKey);
    ...
    value: function authenticateToken(token) {
      try {
        var verifiedJwt = _njwt2.default.verify(token, this.signingKey);
        var emailAddress = verifiedJwt.body.sub;
        return this.userCatalog.fetchByEmail(emailAddress).then(function (user) {
    ...
    value: function validateResetToken(token) {
      return this.passwordRequests.findIndex(function (pr) {
        return pr.token === token;
      }) != -1;
    }
  }, {
    key: 'passwordResetRequest',
    value: function passwordResetRequest(authRequest) {
      // @todo: validate mail config
      var token = (0, _v2.default)();
      var message = this.mail.message;
      message += '"\r\n\r\n' + this.HOSTNAME + '/api/password/form/' + token;
      var self = this;
      return this.userCatalog.fetchByEmail(authRequest.emailAddress).then(function (user) {
        if (user == null) {
          throw Error('No Valid user to send password Reset');
        }
        if (self.mail.disabled != null && self.mail.disabled === true) {
          return Promise.resolve({});
        } else {
          return _mailSender.MailSender.send(self.mail.api, user.emailAddress, self.mail.from, message, self.mail.subject).catch(function (e) {
            throw Error(e.message);
          });
        }
      }).then(function (r) {
        var response = { token: token, emailAddress: authRequest.emailAddress };
        if (self.passwordRequests.findIndex(function (pr) {
          return pr.token === token;
        }) != -1) {
          var i = self.passwordRequests.findIndex(function (pr) {
            return pr.token === token;
          });
    ...
    key: 'passwordReset',
    value: function passwordReset(_passwordReset) {
      var _this2 = this;

      // passwordReset = {password, confirmPassword, token}
      var token = _passwordReset.token;
      if (token != null || token != '') {
        var email = '';
        var req = this.passwordRequests.find(function (e) {
          return e.token === token;
        });
        var self = this;
        if (req != null) {
          email = req.emailAddress;
          return this.userCatalog.fetchByEmail(email).then(function (user) {
            var change = new _user.ChangePassword(user);
            change.password = _passwordReset.password;
            change.confirmpassword = _passwordReset.confirmPassword;
            return _this2.userKernel.execute(change);
          }).then(function (resp) {
            var i = self.passwordRequests.findIndex(function (r) {
...
var AuthenticationService = exports.AuthenticationService = function () {
  ...
  _createClass(AuthenticationService, [{
    ...
    value: function login(req, res, next) {
      var authRequest = new _userCommon.AuthenticationRequest(req.body);

      this.authProvider.authenticate(authRequest).then(function (authResponse) {
    ...
    value: function passwordReset(req, res) {
      ...
      if (authRequest.token === this.passwordResetToken) {
        this.authProvider.passwordResetRequest(authRequest).then(function (response) {
          res.json(response);
        });
      } else {
...
var MyService = exports.MyService = function () {
  function MyService() {
  ...
  _createClass(MyService, [{
    ...
    value: function user(req, res, next) {
      var session = req.sessionData.user;
      this.userKernel.fetchUser(session.id).then(function (user) {
        res.json(user);
      }).catch(next);
    }
  }, {
    ...
    value: function createUser(req, res, next) {
      var newUser = new _user.CreateUser(req.body);
      this.userKernel.execute(newUser).then(function (r) {
        res.json(r);
      }).catch(next);
    }
  }, {
    ...
    value: function editUser(req, res, next) {
      var user = req.sessionData.user;
      var editUser = new _user.EditUser(req.body);
      if (user.emailAddress !== editUser.emailAddress) {
        throw Error('You can only edit the user you are logged in as');
      }
      this.userKernel.execute(editUser).then(function (resp) {
        res.json(resp);
      }).catch(next);
    }
  }]);
...
exports.PasswordHasher = undefined;
...
var PasswordHasher = exports.PasswordHasher = function () {
  function PasswordHasher() {
    _classCallCheck(this, PasswordHasher);
  }

  _createClass(PasswordHasher, [{
    key: 'verifyPassword',
    value: function verifyPassword(password, salt, oldHash) {
    ...
    value: function generateHash(password) {
      var salt = this.generateRandomString(16); /** Gives us salt of length 16 */
      var passwordHashResult = this.sha512(password, salt);
    ...
    key: 'sha512',
    value: function sha512(password, salt) {
...
var UserKernel = exports.UserKernel = function () {
  function UserKernel() {
    _classCallCheck(this, UserKernel);

    this.dependencies = 'userStore=UserStore,passwordHasher=PasswordHasher,userCatalog=UserCatalog,eventHub=EventHub';
  }

  _createClass(UserKernel, [{
    key: 'execute',
    value: function execute(userAction) {
      var _this = this;

      // @todo: Allow for customizable UserEo and User
      if (userAction.commandType === 'create') {
        var userEo = _user.UserEntity.create(_v2.default, this.passwordHasher, userAction);
        return this.userStore.hasUser(userAction.emailAddress).then(function (u) {
          if (!u) {
            throw Error('Account in use.');
          }
          return _this.userStore.saveUser(userEo);
        }).then(function (userSaveEo) {
          _this.userCatalog.push(userSaveEo.toUser());
          return { user: userSaveEo.toUser(), message: 'User Created', actionType: 'create' };
        });
      } else {
        var response = void 0;
        return this.userStore.fetchUserByEmail(userAction.emailAddress).then(function (userFetch) {
          response = userFetch.execute(userAction, _this.passwordHasher);
          return _this.userStore.updateUser(userFetch);
        }).then(function (updateResponse) {
          _this.userCatalog.push(updateResponse.toUser());
    ...
    key: 'fetchUser',
    value: function fetchUser(id) {
      return this.userCatalog.fetchUser(id).then(function (user) {
        return user;
      });
    }
  }, {
...
var _ctjsUtil = __webpack_require__(22);
...
var UserPo = {
  id: { type: _sequelize2.default.TEXT, primaryKey: true },
  version: _sequelize2.default.INTEGER,
  emailaddress: _sequelize2.default.TEXT,
  search: _sequelize2.default.TEXT,
  json: _sequelize2.default.JSONB
};
...
var UserStore = exports.UserStore = function () {
  ...
  _createClass(UserStore, [{
    ...
    value: function updateUser(user) {
      ...
      return this.user.findOne({
        ...
        return u.update(userPo, { where: {
          ...
          var json = res.dataValues.json;
          json = _ctjsUtil.Util.isString(json) ? JSON.parse(json) : json;
          return new _user.UserEntity(json);
        });
      });
    }
  }, {
    ...
    value: function saveUser(user) {
      ...
      return this.user.build(userPo).save().then(function (res) {
        var json = res.dataValues.json;
        json = _ctjsUtil.Util.isString(json) ? JSON.parse(json) : json;
        return new _user.UserEntity(json);
      });
...
var read = __webpack_require__(5)
...
var DelayedStream = __webpack_require__(74);
...
class EventHub {
  ...
  attachEventHub(obj) {
    ...
    obj.subscribe = (channel, callback) => {
      return eventHub.subscribe(obj.constructor.name, channel, callback);
    };

    obj.subscribeOnce = (channel, callback) => {
      return eventHub.subscribeOnce(obj.constructor.name, channel, callback);
    };
    ...
    obj.unsubscribe = () => {
      eventHub.unsubscribe(obj.constructor.name);
    };
  }
}
/* harmony export (immutable) */ __webpack_exports__["EventHub"] = EventHub;
...
var base64Url = __webpack_require__(61).fromBase64;
var Buffer = __webpack_require__(121).Buffer;

var getParamBytesForAlg = __webpack_require__(79);
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(13).concat(__webpack_require__(35)) },
    },
    'xgbk': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(34).concat(__webpack_require__(92)) },
...
var realFetch = __webpack_require__(113);
...
var util = __webpack_require__(1);
var uuid = __webpack_require__(111);
var crypto = __webpack_require__(4);
var ecdsaSigFormatter = __webpack_require__(78);
var properties = __webpack_require__(112);
...
var first = __webpack_require__(80)
...
var bytes = __webpack_require__(3)
var iconv = __webpack_require__(14)
var unpipe = __webpack_require__(126)
...
var codes = __webpack_require__(124)
...
exports.NodeFlare = exports.MailSender = exports.Router = exports.TokenAuthenticator = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _tokenAuthenticator = __webpack_require__(45);

Object.defineProperty(exports, 'TokenAuthenticator', {
  enumerable: true,
  get: function get() {
    return _tokenAuthenticator.TokenAuthenticator;
  }
});
...
Object.defineProperty(exports, 'Router', {
  enumerable: true,
  get: function get() {
    return _express.Router;
  }
});

var _mailSender = __webpack_require__(20);

Object.defineProperty(exports, 'MailSender', {
  enumerable: true,
  get: function get() {
    return _mailSender.MailSender;
  }
});
...
var _iocBuilder = __webpack_require__(44);
...
var _dbConnection = __webpack_require__(43);

var _ctjsDi = __webpack_require__(48);
...
var AppRoot = function () {
  function AppRoot(config) {
    ...
    this.config = config;
    this._expApp = (0, _express2.default)();
  ...
  _createClass(AppRoot, [{
    key: 'withAuth',
    value: function withAuth() {
      var authErrorHandler = function authErrorHandler(err, req, res, next) {
      ...
      this._expApp.use(_tokenAuthenticator.TokenAuthenticator.handleRequest);
    ...
    value: function start() {
      ...
      this._expApp.use((0, _cors2.default)({
        exposedHeaders: "Link"
      }));
      ...
      this._expApp.use(_bodyParser2.default.json());
      this._expApp.use(_bodyParser2.default.urlencoded({ extended: true }));
      ...
      try {
        for (var _iterator = this._registeredRouters[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var r = _step.value;

          var c = ctx.get(r.name);
...
var Utilities = function () {
  ...
  _createClass(Utilities, null, [{
    key: 'configureDb',
    value: function configureDb(config) {
      if (config.database == null || config.database.type === 'sqlite') {
        if (config.database == null || config.database.path == null) {
          ctx.register('db', _dbConnection.SqliteConnection, [null]);
        } else {
          ctx.register('db', _dbConnection.SqliteConnection, [config.database.path]);
        }
      } else if (config.database.type === 'pg') {
        if (config.database.uri != null && config.database.uri !== '') {
          ctx.register('db', _dbConnection.PgConnectionUri, [config.database.uri, config.database.ssl]);
        } else {
          ctx.register('db', _dbConnection.PgConnection, [config.database.host, config.database.user, config.database.password, config.database.db, config.database.ssl]);
        }
      } else if (config.database.type === 'pg-heroku') {
        var uri = process.env.DATABASE_URL;
        ctx.register('db', _dbConnection.PgConnectionUri, [uri]);
      }
    }
  }]);
...
var NodeFlare = exports.NodeFlare = function () {
  function NodeFlare(config) {
    _classCallCheck(this, NodeFlare);

    global.ctx = _ctjsDi.Di.createContext();
    this.config = config;
    ...
    _iocBuilder.IocBuilder.build(this.appRoot);

    Utilities.configureDb(this.config);
  }

  _createClass(NodeFlare, [{
    key: 'appSet',
    value: function appSet(setting, val) {
      if (!_ctjsUtil.Util.isString(setting) || !_ctjsUtil.Util.isString(setting)) throw Error('Both Setting and Value must be a string');
    ...
    key: 'appUse',
    value: function appUse(path, func) {
      if (!_ctjsUtil.Util.isFunction(path)) {
        if (!_ctjsUtil.Util.isFunction(func)) throw Error('AppUse requires a function');
    ...
    key: 'static',
    value: function _static(dir) {
      if (dir == null || dir.length <= 0) throw Error('Directory Must be Defined');
      if (arguments.length > 1) {
        var virtualPath = arguments[1];
        this.appRoot._expApp.use(virtualPath, _express2.default.static(dir));
      } else {
        this.appRoot._expApp.use(_express2.default.static(dir));
      }
      return this;
    }
  }, {
    key: 'withAuthServices',
    value: function withAuthServices() {
      this.appRoot.enableAuthSevices = true;
      return this;
    }
  }, {
    key: 'withTokenAuth',
    value: function withTokenAuth(tokenAuth) {
      if (!_ctjsUtil.Util.isFunction(tokenAuth)) throw Error('Token Authenticator must be a function');
      this.appRoot._expApp.use(tokenAuth);
      return this;
    }
  }, {
    key: 'whitelist',
    value: function whitelist(val) {
      _tokenAuthenticator.TokenAuthenticator.addwhitelist(val);
      return this;
    }
  }, {
    key: 'register',
    value: function register(name, obj, constructorArgs) {
      if (_ctjsUtil.Util.isArray(constructorArgs)) {
    ...
    key: 'registerAndUse',
    value: function registerAndUse(path, name, obj, constructorArgs) {
      if (_ctjsUtil.Util.isArray(constructorArgs)) {
        ctx.register(name, obj, constructorArgs);
      } else {
        ctx.register(name, obj);
    ...
    value: function start() {
      ...
      var appRoot = ctx.get('AppRoot');
      appRoot.start();
      // Fire the update catalog event so that we build the initial catalog
      var eventHub = ctx.get('EventHub');
      eventHub.publish(_userCache.UserCatalog.Update);

      appRoot._expApp.listen(this.port, function () {
        return console.log('App is listening on port ' + _this.port);
      });
